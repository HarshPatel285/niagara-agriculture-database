# 🌾 Niagara Agriculture Database Design
...
The goal is to model real-world agricultural operations and demonstrate strong skills in **database design, SQL query optimization, and automation with triggers**.

---

## 🚀 Project Overview
- **Objective:** Build a scalable, normalized relational database for an agricultural business.  
- **Deliverables:** ER Diagrams, DDL/DML scripts, advanced SQL queries, and automated triggers.  
- **Focus Areas:** Data Modeling, Normalization, Query Optimization, and Inventory Management.  
...
1. **Database Schema**
   ...
   - DDL scripts with primary/foreign keys, unique constraints, and check conditions  

2. **Data Management**
   - DML scripts for inserts, updates, and deletes
   - Sample dataset for employees, customers, suppliers, products, and orders  

3. **Business Use Cases (SQL Queries)**
...
4. **Automation**
   - Triggers for inventory stock management  
